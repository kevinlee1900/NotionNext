...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'yoyopaper', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否显示切换主题按钮
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_SINCE || 1991, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  // 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个互联网民工,长期不明真相的群众,在有限性中打坐的凡人,欢迎来到我的博客🎉', // 

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '觉吾', // 您的昵称 例如 觉吾
  BIO: process.env.NEXT_PUBLIC_BIO || '李觉吾', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jike.city/ariotrio', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '敬知识人性，畏客观规律', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ariotrio@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_JIKE: process.env.NEXT_PUBLIC_CONTACT_JIKE || 'https://jike.city/ariotrio', // 你的微博个人主页
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || 'sowell2100', // 你的twitter个人主页
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'http://www.socialbrain.cn', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
